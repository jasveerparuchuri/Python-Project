...
btn_backspace = Button(root, text="<--", bd=5, relief="groove", bg="#FFC0CB", width=15, command=backspace)
...
button_reset = Button(root, text="RESET", bd=5, relief="groove", bg="#FFFF00",width=15, command=reset)
...
button_convert = Button(root, text="CONVERT", bd=5, relief="groove", bg="#0000FF", width=15,  command=convert)
...
root.title("Complete Number Base Converter")
